    ...
    <section id="helyszin" className="py-24 px-4 bg-card/50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="rounded-xl overflow-hidden border border-border">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2683.5!2d17.6347!3d47.6875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDfCsDQxJzE1LjAiTiAxN8KwMzgnMDUuMCJF!5e0!3m2!1shu!2shu!4v1"
            width="100%"
            height="300"
            style={{ border: 0 }}
            allowFullScreen
